...
#
# Modified by Ricardo de Azambuja and Samuel Arseneault
#
...
class NatNetClient(object):
    ...
    def __unpackMocapData(self, data):
        ...
        if ((self.__natNetStreamVersion[0] == 2 and self.__natNetStreamVersion[1] >= 11)
                or self.__natNetStreamVersion[0] > 2):
    ...
    def __unpackRigidBodyDescription(self, data):
        ...
        self.rigidBodyDescriptor[name.decode("utf-8")] = (rigidbody_ID, rigidbody_parentID, rigidbody_timestamp)
    ...
    def __dataThreadFunction(self, socketd, timeout=0.1):
        ...
        while self.is_alive:
            try:
                ...
                trace('NatNetClient socket timeout!')
                continue
        try:
