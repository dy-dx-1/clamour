...
anchor_prior_pos = [(0, -1), (0, 1), (-1, 0), (3,3), (4, 3), (5, 2), (4,1)]
...
for z, (x, y) in zip([z1, z2, z3, z4, z5, z6, z7], anchor_prior_pos): 
...
graph.add(gt.RangeFactor2D(x5, z5, 1.1, RANGE_NOISE))
graph.add(gt.RangeFactor2D(x5, z6, 0.95, RANGE_NOISE))
graph.add(gt.RangeFactor2D(x5, z7, 0.98, RANGE_NOISE))
